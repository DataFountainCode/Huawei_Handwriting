...
def parse_args():
    ...
    parser.add_argument('--train_data_num', default=200, help='training_data_num')
...
def main():
    ...
    mmcv.dump(splited_train, os.path.join(out_dir, 'mini_train.pkl'))
    mmcv.dump(splited_val, os.path.join(out_dir, 'mini_val.pkl'))
    ...
    print('[Total img]')
    print('mini_train: ', len(splited_train))
    print('mini_val: ', len(splited_val))
