...
class BaseSampler(metaclass=ABCMeta):
    ...
    def sample(self, assign_result, bboxes, gt_bboxes, gt_bboxes_8_coo=None, gt_labels=None):
        ...
        return SamplingResult(pos_inds, neg_inds, bboxes, gt_bboxes, gt_bboxes_8_coo,
