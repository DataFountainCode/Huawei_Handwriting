...
from mmdet.core.bbox import delta2bbox_8_coo                        
...
class RPNHead(nn.Module):
    ...
    def __init__(self,
        ...
        if with_8_coo:
            self.rpn_reg = nn.Conv2d(feat_channels, self.num_anchors * 8, 1)
        else:
    ...
    def loss_single(self, rpn_cls_score, rpn_bbox_pred, labels, label_weights,
                    bbox_targets, bbox_weights, num_total_samples, coo_num, cfg):
        # classification loss
        ...
        # regression loss
        bbox_targets = bbox_targets.contiguous().view(-1, coo_num)
        bbox_weights = bbox_weights.contiguous().view(-1, coo_num)
    ...
    def get_proposals(self, rpn_cls_scores, rpn_bbox_preds, img_meta, coo_num, cfg):
        ...
        for img_id in range(num_imgs):
            ...
            proposals = self._get_proposals_single(
                ...
                img_meta[img_id]['img_shape'], coo_num, cfg)
