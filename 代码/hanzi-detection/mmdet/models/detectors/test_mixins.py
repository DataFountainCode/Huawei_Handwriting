...
class RPNTestMixin(object):
    ...
    def simple_test_rpn(self, x, img_meta, coo_num, rpn_test_cfg):
        rpn_outs = self.rpn_head(x)
        proposal_inputs = rpn_outs + (img_meta, coo_num, rpn_test_cfg)
...
class BBoxTestMixin(object):
    ...
    def simple_test_bboxes(self,
        ...
        roi_feats = self.bbox_roi_extractor(
            x[:len(self.bbox_roi_extractor.featmap_strides)], rois, self.level, self.merge_mode)
